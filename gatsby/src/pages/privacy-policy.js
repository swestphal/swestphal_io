...
const PrivacyPolicyPage = () => (
  <div className="page page-privacy">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Simone Westphal, Untere Dorfstrasse 5a,
      ...
      <li>
        <p>
          <strong>Website</strong> refers to swestphal, accessible from{' '}
          <a
            href="swestphal.io"
    ...
    <ul>
      <li>
        <p>By email: hello@swestphal.io</p>
      </li>
      <li>
        <p>
          By visiting this page on our website:{' '}
          <a
            href="https://swestphal.io/privacy-policy"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://swestphal.io/privacy-policy
          </a>
        </p>
      </li>
    </ul>
